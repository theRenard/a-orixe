  ...
  <div class="container">
    <div class="centered">
      <p class="type__section-paragraph mt-5">
        {{ $t('association.paragraph1') }}
      </p>
      <p class="type__question association-section__blockquote mt-3">
        {{ $t('association.blockquote') }}
      </p>
      <div class="association-section__row mt-3">
...
<style scoped>
.association-section__blockquote {
