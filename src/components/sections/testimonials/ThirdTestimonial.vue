...
<section ref="sectionRoot"
  :class="['section', `section-${sectionIndex}`, 'testimonial', 'section--full-viewport', 'with-background', 'with-shadow', 'third-testimonial']"
  data-block data-component="ThirdTestimonial">
