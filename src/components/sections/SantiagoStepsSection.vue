...
onMounted(() => {
  ...
  useAnimation({
    ...
    tweens: [
      ...
      { el: image, from: { x: 80, opacity: 0, rotation: 12 }, to: { x: 0, opacity: 1, delay: 0.08, rotation: 0, ease: 'power3.out' } },
      { el: question, from: { y: -80, opacity: 0 }, to: { y: 0, opacity: 1, delay: 0.16, ease: 'power3.out' } },
    ],
  })
})
</script>
...
<doc lang="text">
  ...
  - elements: [{ el: sectionRoot, direction: 'down', delay: 0, duration: 3 }, { el: title, direction: 'left', delay: 0 }, { el: image, direction: 'right', delay: 0.08, rotation: 12 }, { el: question, direction: 'down', delay: 0.16 }]
  - offset: 44
  - ease: 'power3.out'
  - runOnMount: false
</doc>
