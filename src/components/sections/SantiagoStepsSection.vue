...
<section class="santiago-steps-section">
  <div class="container">
    <div class="centered">
      ...
      <p class="type__section-paragraph--italic paragraph-spacing" v-html="$t('santiagoSteps.paragraph1')"></p>
      <p class="type__section-paragraph--italic paragraph-spacing" v-html="$t('santiagoSteps.paragraph2')"></p>
