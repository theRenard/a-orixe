...
.language-selector {
  ...
  opacity: 1;
  padding: calc(0.4375rem * var(--scale-medium));
  gap: 0.4rem;
  height: calc(2.1875rem * var(--scale-medium));
  width: calc(4.6875rem * var(--scale-medium));
  border-bottom: calc(0.1875rem * var(--scale-medium)) solid var(--color-orange);
}
